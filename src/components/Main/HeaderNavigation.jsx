...
import SingOutDropdown from '../SignIn/SingOutDropdown.jsx';

function HeaderNavigation({ changeSingOutState, isSingOutActive }) {
  ...
  return (
    <div className="right-header-content col-s-6">
      ...
      <div className="right-header-content-icons">
        ...
        <div className="account-icon-link">
          <svg
      ...
      <SingOutDropdown changeSingOutState={changeSingOutState} isSingOutActive={isSingOutActive} />
    </div>
  );
}
